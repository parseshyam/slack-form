...
const slackForm = SlackFormManager.create(form, {});
...
test('Single select input test [String, Should match slack value]', (t) => {
    ...
    if (singleSelectInputValue) {
        ...
        assert.strictEqual(singleSelectInputValue, undefined, "Single select value empty case");
    }
});
...
test('Multi select input test [Array, Should match slack values]', (t) => {
    ...
    if (multiselectInputValue) {
        ...
        assert.deepEqual(multiselectInputValue, undefined, "Multi select value empty case");
    }
});
...
test('Single user select input test [String, Should match slack value]', (t) => {
    ...
    if (singleSelectUserInputValue) {
        ...
        assert.strictEqual(singleSelectUserInputValue, undefined, "Single select empty case");
    }
});
...
test('Multi user select input test [Array, Should match slack values]', (t) => {
    ...
    if (multiselectUserInputValue) {
        ...
        assert.deepEqual(multiselectUserInputValue, undefined, "Multi select user empty case");
    }
});
...
test('Single channel select input test [String, Should match slack value]', (t) => {
    ...
    if (singleSelectChannelInputValue) {
        ...
        assert.strictEqual(singleSelectChannelInputValue, undefined, "Single select channel empty case");
    }
});
...
test('Multi channel select input test [Array, Should match slack values]', (t) => {
    ...
    if (multiSelectChannelInputValue) {
        ...
        assert.deepEqual(multiSelectChannelInputValue, undefined, "Multiselect channel empty case");
    }
});
...
test('Input test [String, Should match slack value]', (t) => {
    ...
    if (textInputValue) {
        ...
        assert.strictEqual(textInputValue, undefined, "Input text empty case");
    }
});
...
test('Radio input test [String, Should match slack value]', (t) => {
    ...
    if (radioInputValue) {
        ...
        assert.strictEqual(radioInputValue, undefined, "Radio empty case");
    }
});
...
test('Checkbox input test [Array, Should match slack values]', (t) => {
    ...
    if (checkboxInputValue) {
        ...
        assert.deepEqual(checkboxInputValue, undefined, "checkbox input empty case");
    }
});
...
test('Date input test [String, Should match slack value]', (t) => {
    ...
    if (dateInputValue) {
        ...
        assert.strictEqual(dateInputValue, undefined, "Date empty case");
    }
});
...
test('Time input test [String, Should match slack value]', (t) => {
    ...
    if (timeInputValue) {
        ...
        assert.strictEqual(timeInputValue, undefined, "Time empty case");
    }
});
...
test('Date time input test [Number(unix), Should match slack value]', (t) => {
    ...
    if (timeInputValue) {
        ...
        assert.strictEqual(timeInputValue, undefined, "Date time empty case");
    }
});