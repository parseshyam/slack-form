const { HelperBlocks, SlackBlocks } = require("./blocks")
...
class SlackFormManager {
     ...
     * @returns {Array}
     */
    renderForm(initialValues = {}, config = {}) {
        ...
        blocks = HelperBlocks.paginateBlocks(formId, blocks, config);
    ...
    getFormValues() {
        ...
        const { id: formId, blocks: formBlocks, skipValue = false } = form;
