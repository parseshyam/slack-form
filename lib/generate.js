...
function manageForm(form, stateValues = {}) {
    ...
    return {
        renderForm: renderForm.bind({ form, formValues }),
        getFormValues: getFormValues.bind({ form, stateValues }),
        addBlock: addBlock.bind({ form }),
        addBlocks: addBlocks.bind({ form }),
        removeBlocks: removeBlocks.bind({ form }),
        setErrors: setErrors.bind({ form }),
    }
}
